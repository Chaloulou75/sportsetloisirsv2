...
// Route::get('/localite-{city}-1/dis-{discipline:slug}/cat-{category:id}/{structure}', [CityDisciplineCategorieStructureController::class, 'show'])->name('villes.disciplines.categories.structures.show');
