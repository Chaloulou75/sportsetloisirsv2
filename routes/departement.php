...
Route::get('/dept-{departement}/activites-{activite}-{slug}', [DepartementActiviteController::class, 'show'])->name('departements.activites.show');
...
Route::get('/dept-{departement}/dis-{discipline}/activites-{activite}-{slug}', [DepartementDisciplineActiviteController::class, 'show'])->name('departements.disciplines.activites.show');
...
Route::get('/dept-{departement}/dis-{discipline}/cat-{category:slug}/activites-{activite}-{slug}', [DepartementDisciplineCategorieActiviteController::class, 'show'])->name('departements.disciplines.categories.activites.show');
...
Route::get('/dept-{departement}/dis-{discipline}/type-{structuretype}/activites-{activite}-{slug}', [DepartementDisciplineStructuretypeActiviteController::class, 'show'])->name('departements.disciplines.structuretypes.activites.show');
