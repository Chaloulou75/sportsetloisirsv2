...
watch(
    ...
    (newValue) => {
        if (newValue) {
            ...
            const tarifType = props.tarifTypes.find((type) => type.id === newValue.type_id);
            formEditTarif.tarifType = tarifType ? tarifType : props.tarifTypes[0];

            const uniteDuree = uniteDurees.find((unite) => unite.name === newValue.structure_tarif_type_infos[0].unite);
            formEditTarif.uniteDuree = uniteDuree ? uniteDuree : uniteDurees[0];

            formEditTarif.attributs = newValue.structure_tarif_type_infos.reduce((acc, attribut) => {
...
watch(() => formEditTarif.categories, (newValue) => {
    if (newValue) {
        formEditTarif.activites = {};
        formEditTarif.produits = {};
...
watch(() => formEditTarif.activites, (newValue) => {
    if (newValue) {
        formEditTarif.produits = {};
                            ...
                            <DialogPanel
                                ...
                                <form @submit.prevent="onSubmitAddTarifForm()" autocomplete="off">
                                    ...
                                    <div class="w-full mt-2">
                                        <div class="flex flex-col space-y-3">
                                            <div
                                                ...
                                                <div class="w-full md:w-1/2">
                                                    ...
                                                    <div class="flex mt-1 rounded-md">
                                                        <input v-model="formEditTarif.titre
                                                ...
                                                <Listbox class="w-full md:w-1/2" v-model="formEditTarif.tarifType">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <textarea v-model="formEditTarif.description
                                            ...
                                            <div v-if="formEditTarif.tarifType"
                                                class="flex flex-col items-center justify-start w-full space-x-0 space-y-2 md:flex-row md:space-y-0 md:space-x-2">
                                                <div v-for="attribut in formEditTarif.tarifType.tariftypeattributs"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex mt-1 rounded-md">
                                                            <input v-model="formEditTarif.attributs[attribut.id]"
                                                    ...
                                                    <Listbox v-if="attribut.attribut === 'Duree'"
                                                        v-model="formEditTarif.uniteDuree" class="w-56">
                                                        <div class="relative">
                                            ...
                                            <div class="w-full md:w-1/2">
                                                ...
                                                <div class="flex items-center mt-1 rounded-md">
                                                    <input v-model="formEditTarif.amount
                                                ...
                                                <div v-for="discipline in props.activiteForTarifs" :key="discipline.id"
                                                    ...
                                                    <label class="flex items-center">
                                                        <input type="checkbox" :id="discipline.id" :value="discipline.id"
                                                            ...
                                                            v-model="formEditTarif.disciplines[discipline.id]"
                                                            class="text-indigo-600 border-gray-300 rounded shadow-sm focus:ring-indigo-500" />
                                                    ...
                                                    <div v-for="category in discipline.categories" :key="category.id"
                                                        ...
                                                        <label class="flex items-center">
                                                            <input type="checkbox" :id="category.id" :value="category.id"
                                                                :name="category.name"
                                                                v-model="formEditTarif.categories[category.id]"
                                                                class="text-indigo-600 border-gray-300 rounded shadow-sm focus:ring-indigo-500" />
                                                            <span class="ml-2 text-sm text-gray-600">{{
                                                                category.name
                                                            }}</span>
                                                        ...
                                                        <div v-for="activite in category.activites" :key="activite.id"
                                                            ...
                                                            <label class="flex items-center">
                                                                <input type="checkbox" :id="activite.id"
                                                                    ...
                                                                    v-model="formEditTarif.activites[activite.id]"
                                                                    class="text-indigo-600 border-gray-300 rounded shadow-sm focus:ring-indigo-500" />
                                                            ...
                                                            <div
                                                                ...
                                                                <label v-for="produit in activite.produits"
                                                                    ...
                                                                    <input type="checkbox" :id="produit.id"
                                                                        ...
                                                                        v-model="formEditTarif.produits[produit.id]"
                                                                        class="text-indigo-600 border-gray-300 rounded shadow-sm focus:ring-indigo-500" />
                                    ...
                                    <div class="flex items-center justify-between w-full mt-4">
                                        ...
                                        <button :disabled="formEditTarif.processing" type="submit"
