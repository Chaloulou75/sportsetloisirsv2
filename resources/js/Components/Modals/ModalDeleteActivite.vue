        ...
        <TransitionRoot as="template" :show="show">
            <Dialog as="div" class="relative z-10" @close="open = false">
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0" enter-to="opacity-100"
                    ...
                    <div class="fixed inset-0 transition-opacity bg-gray-800 bg-opacity-50" />
                </TransitionChild>

                <div class="fixed inset-0 z-10 overflow-y-auto">
                    <div class="flex items-end justify-center min-h-full p-4 text-center md:items-center md:p-0">
                        <TransitionChild as="template" enter="ease-out duration-300"
                            ...
                            <DialogPanel
                                ...
                                <div class="px-4 pt-5 pb-4 bg-white md:p-6 md:pb-4">
                                    <div class="md:flex md:items-start">
                                        ...
                                        <div class="mt-3 text-center md:ml-4 md:mt-0 md:text-left">
                                            <DialogTitle as="div" class="flex items-start justify-between w-full">
                                                <h3
                                ...
                                <div class="justify-between px-4 py-3 space-y-2 bg-gray-50 md:flex md:space-y-0 md:px-6">
                                    <button type="button"
