        ...
        <TransitionRoot appear :show="show" as="template">
            <Dialog as="div" @close="open = false" class="relative z-10">
                ...
                <div class="fixed inset-0 overflow-y-auto">
                    <div
                        class="flex items-center justify-center min-h-full p-4 text-center h-5/6"
                    >
                        <TransitionChild
                            as="template"
                            enter="duration-300 ease-out"
                                    ...
                                    <div class="w-full mt-2">
                                        <div class="flex flex-col space-y-3">
                                            ...
                                            >
                                                ...
                                                <!-- Adresse -->
                                                <div
                                                    class="flex flex-col md:flex-row items-end justify-between w-full space-x-0 md:space-x-4 space-y-2 md:space-y-0"
                                                >
                                                    <div
                                                        v-if="
                                                            !addProduitAddress
