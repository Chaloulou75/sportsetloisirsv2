...
const destroyStructure = () => {
    router.delete(route("structures.destroy", props.structure), {
        preserveScroll: true,
    });
};
</script>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    class="px-4 py-3 space-y-2 bg-gray-50 md:flex md:justify-between md:space-y-0 md:px-6"
                                >
                                    <button
                                        type="button"
