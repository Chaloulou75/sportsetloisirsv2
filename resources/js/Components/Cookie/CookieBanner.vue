        ...
        <div class="p-4 bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="flex gap-x-4">
                ...
                <p class="text-sm text-gray-800 dark:text-gray-200">
                    En visitant ce site, vous acceptez notre
                    <a
                ...
                <div>
                    <button
                        ...
                        type="button"
                        class="inline-flex items-center p-2 text-sm font-semibold text-gray-500 border border-transparent rounded-full gap-x-2 hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50"
