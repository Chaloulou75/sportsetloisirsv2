...
<template>
    ...
    >
        ...
        <p class="text-base font-semibold">
            ...
            >: création, mise à jour de vos disciplines, activités et produits,
            ou seulement pour certains d'entre eux.
        </p>
        <ul class="list-inside list-disc text-base">
            <li>
                <span class="font-semibold">Super Administrateur</span> a accès
                à tous les droits d'administration et de gestion sur la
                structure et ses activités. Il est unique par structure.
            </li>
            <li>
                <span class="font-semibold">Administrateur</span> a accès à
                certains droits d'administration et de gestion, notamment sur
                les activités de la structure.
            </li>
            <li>
                <span class="font-semibold">Sans permission</span> n'a accès à
                aucun droit d'administration et de gestion sur la structure ou
                ses activités, mais accès aux informations de celle-ci.
            </li>
        </ul>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div>
                ...
                <div class="mt-1 flex rounded-md">
                    <input
                        ...
                        id="contact"
                        :class="{
                            'border-red-400': addPermissionForm.errors.contact,
                        }"
            ...
            <template v-if="addPermissionForm.niveau === 2">
                <div v-for="activite in structure.activites" :key="activite.id">
                    <label class="flex items-center">
                        <input
                            ...
                            :value="activite.id"
                            :name="activite.id"
                            v-model="addPermissionForm.activites[activite.id]"
