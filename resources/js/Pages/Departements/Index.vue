...
<template>
    <Head title="Departements" :description="
    ...
    <AppLayout>
                ...
                <nav aria-label="Breadcrumb" class="flex">
                    <ol class="flex overflow-hidden rounded-lg border border-gray-200 text-gray-600">
                        ...
                        <li class="relative flex items-center">
                            ...
                            <Link preserve-scroll :href="route('departements.index')"
        ...
        <div class="py-12">
            ...
            <div class="mx-auto mb-8 mt-4 flex w-full max-w-3xl flex-col items-center justify-center px-2 md:flex-row">
                <label for="search" value="Rechercher dans votre departement:"
                    class="mb-1 pr-2 text-sm font-medium text-gray-800">Rechercher un departement:</label>
                ...
                <TextInput id="search" type="text"
                    ...
                    v-model="search" placeholder="departement..." />
            ...
            <div class="mx-auto min-h-screen max-w-full px-2 sm:px-6 lg:px-8">
                <div class="grid h-auto grid-cols-1 place-items-stretch gap-4 sm:grid-cols-2 md:grid-cols-3">
                    <Link :href="route('departements.show', departement.id)" :active="
                        ...
                        " v-for="(departement, index) in departements.data" :key="departement.id" :index="index"
                    ...
                    <div v-if="departement.structures_count > 0" class="text-xs">
                        ({{ departement.structures_count }}
                        <span v-if="departement.structures_count > 1">structures</span>
