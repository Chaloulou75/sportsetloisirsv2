...
<template>
    <Head title="Structures" :description="
    ...
    <AppLayout>
                ...
                <nav aria-label="Breadcrumb" class="flex">
                    <ol class="flex overflow-hidden rounded-lg border border-gray-200 text-gray-600">
                        ...
                        <li class="relative flex items-center">
                            ...
                            <Link preserve-scroll :href="route('structures.index')"
        ...
        <div class="py-12">
            ...
            <div class="mx-auto mb-8 mt-4 flex w-full max-w-3xl flex-col items-center justify-center px-2 md:flex-row">
                <label for="search" value="Rechercher une structure"
                    class="mb-1 pr-2 text-sm font-medium text-gray-800">Rechercher une structure:</label>
                ...
                <TextInput id="search" type="text"
                    ...
                    v-model="search" placeholder="structure, discipline, ville..." />
            ...
            <template v-if="structures.data.length > 0">
                <div class="mx-auto flex min-h-screen max-w-full flex-col px-2 sm:px-6 md:flex-row md:space-x-4 lg:px-8">
                    ...
                    <LeafletMapMultiple class="md:sticky md:top-2 md:w-1/2" :structures="structures.data"
                        :hovered-structure="hoveredStructure" :zoom="7" />
                </div>
            </template>
            <template v-else>
