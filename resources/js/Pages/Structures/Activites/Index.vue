                    ...
                    <form @submit.prevent="submit" autocomplete="off">
                        <div class="min-h-screen shadow-md shadow-sky-700 sm:overflow-hidden sm:rounded-md">
                            <div
                                ...
                                <!-- discipline -->
                                <AutocompleteActiviteFormSmall class="h-full w-full md:w-1/2" :disciplines="listDisciplines"
                                    :dejaUsedDisciplines="
                                        dejaUsedDisciplinesRef
                                    " :errors="form.errors" v-model:discipline="form.discipline_id"
                                    :selectedDiscipline="selectedDiscipline" @update:modelValue="
                                        (discipline) =>
                            ...
                            <div v-if="form.discipline_id" class="w-full px-4 py-5 sm:p-6">
                                <label for="categories" class="mb-4 block text-lg font-medium text-gray-700">
                                        ...
                                        <li v-for="categorie in categoriesList" :key="categorie.id" class="py-2">
                                            <div class="flex items-center justify-between">
                                                <input name="categories" id="categories" v-model="form.categories_id"
                                                    type="checkbox" multiple :value="categorie.id" :checked="
                                    ...
                                    <div class="flex w-full flex-col justify-start space-y-2">
                                        <div v-if="activite"
                                            ...
                                            <button type="button" @click="
                                                ...
                                                <TrashIcon class="mr-1 h-6 w-6 text-gray-600 hover:text-red-600" />
                                            </button>
                                        </div>
                                        <div v-if="activite.categories"
                                            class="grid grid-cols-1 place-items-stretch gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                            <div class="flex flex-col items-center justify-between rounded bg-white px-4 py-3 text-lg text-gray-600 shadow-lg transition duration-150 hover:bg-darkblue hover:text-white hover:ring-2 hover:ring-green-400 hover:ring-offset-2 focus:ring-2 focus:ring-green-400 focus:ring-offset-2 sm:rounded-lg"
                                                v-for="(
                                                    categorie, index
