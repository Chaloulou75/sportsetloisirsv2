            ...
            <div class="flex flex-col items-start justify-between md:flex-row">
                <div>
                    <h2 class="text-xl font-semibold leading-tight text-gray-800">
                        {{ structure.name }}
                        <span class="text-xs italic text-gray-600">({{ structure.view_count }} vues)
                        </span>
                    </h2>
                    <!-- <div
                ...
                <div v-if="$page.props.auth.user" class="mt-4 w-full md:mt-0 md:w-1/4">
                    <div v-if="can.update" class="flex flex-col justify-between space-y-4 md:ml-4 md:space-y-6">
                        <Link :href="
                        ...
                        <ModalDeleteStructure :structure="structure" :show="showModal" @close="showModal = false" />
                    </div>
                </div>
            </div>
        </template>
                ...
                <div class="w-full space-y-4 md:w-2/3 md:pr-10">
                    <div class="relative mb-4 md:mb-6">
                        ...
                        <div class="my-4 flex items-center justify-start space-x-4">
                            ...
                            <h2 class="inline-block text-xl font-semibold text-black sm:text-2xl sm:leading-7 md:text-3xl">
                                {{ structure.name }}
                            </h2>
                        </div>
                    </div>
