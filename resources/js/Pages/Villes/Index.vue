...
<template>
    <Head title="Localités - Villes" :description="
    ...
    <AppLayout>
                ...
                <nav aria-label="Breadcrumb" class="flex">
                    <ol class="flex overflow-hidden rounded-lg border border-gray-200 text-gray-600">
                        ...
                        <li class="relative flex items-center">
                            ...
                            <Link preserve-scroll :href="route('villes.index')"
        ...
        <div class="py-12">
            ...
            <div class="mx-auto mb-8 mt-4 flex w-full max-w-3xl flex-col items-center justify-center px-2 md:flex-row">
                <label for="search" value="Rechercher dans votre ville:"
                    class="mb-1 pr-2 text-sm font-medium text-gray-800">Rechercher une ville:</label>
                ...
                <TextInput id="search" type="text"
                    ...
                    v-model="search" placeholder="ville..." />
            ...
            <div class="mx-auto min-h-screen max-w-full px-2 sm:px-6 lg:px-8">
                <div class="grid h-auto grid-cols-1 place-items-stretch gap-4 sm:grid-cols-2 md:grid-cols-3">
                    <Link :href="route('villes.show', city.id)" :active="route().current('villes.show', city.id)"
                        v-for="(city, index) in cities.data" :key="city.id" :index="index"
                    ...
                    <div v-if="city.structures_count > 0" class="text-xs">
                        ...
                        <span v-if="city.structures_count > 1">structures</span>
