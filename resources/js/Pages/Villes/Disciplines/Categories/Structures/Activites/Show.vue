...
<template>
    ...
    <AppLayout>
        ...
        <template #default>
            <div class="mx-auto max-w-full px-2 sm:px-3 lg:px-6">
            ...
            <section class="mx-auto max-w-full px-0 py-6 sm:px-4 lg:px-8">
                <div
                ...
                >
                    <div class="w-full space-y-12 md:w-1/3">
                        <Link
                            class="my-6 hidden items-center justify-center rounded border border-indigo-600 bg-indigo-600 px-6 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 hover:shadow focus:outline-none focus:ring active:text-indigo-500 md:flex"
                            preserve-scroll
                            :href="
                                route(
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <button
                                                            class="my-4 inline-block w-full rounded border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 md:w-auto"
                                                            type="button"
                                                            @click="
                                                    ...
                                                    <button
                                                        v-if="
                                                            reservationForm.formule
                                                        "
                                                        class="my-4 inline-block w-full self-end rounded border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 md:w-auto"
                                                        type="submit"
                                                        :disabled="
