...
<template>
    ...
    <AppLayout>
        <template #header>
            ...
            <div class="my-4 flex w-full flex-col items-center justify-center space-y-2">
                ...
                <h1 class="text-xl font-semibold leading-tight tracking-widest text-gray-800">
                    ...
                    <span class="text-xs italic tracking-tight text-gray-600">({{ city.view_count }} vues)
                    </span>
                </h1>
        ...
        <template v-if="structures.data.length > 0">
            <div class="mx-auto max-w-full px-2 py-6 md:py-12 sm:px-6 md:space-x-4 lg:px-8">
                <h2 class="mb-4 text-center text-lg font-semibold text-gray-600">
                ...
                <div
                    ...
                    <div v-for="discipline in flattenedDisciplines" :key="discipline.id">
                        <Link :href="
                            ...
                            "
                            class="inline-block rounded border border-gray-600 px-12 py-3 text-base font-medium text-gray-600 shadow-sm hover:border-gray-100 hover:bg-indigo-500 hover:text-white hover:shadow-lg focus:outline-none focus:ring active:bg-indigo-500 w-48 text-center">
                        {{ discipline.name }}
                        </Link>
                    </div>
                </div>
            ...
            <div class="mx-auto flex min-h-screen max-w-full flex-col px-2 py-12 sm:px-6 md:flex-row md:space-x-8 lg:px-8">
                <div class="md:w-1/2">
