...
<template>
    <Head title="Disciplines" :description="'Trouvez un club de sport ou un cours collectif parmi plus de ' +
        disciplines.total +
    ...
    <AppLayout>
        ...
        <div class="py-12">
            <!-- search box -->
            <div class="mx-auto mt-4 mb-8 flex w-full max-w-3xl flex-col items-center justify-center px-2 md:flex-row">
