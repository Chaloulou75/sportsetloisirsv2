                ...
                <div class="mx-auto py-6 md:py-12">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="grid h-auto grid-cols-1 place-content-stretch place-items-stretch justify-items-stretch gap-4 lg:grid-cols-2"
                                >
                                    <ProduitCard
                                        v-for="(
                                            produit, index
