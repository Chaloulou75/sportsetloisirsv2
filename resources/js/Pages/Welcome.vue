...
<template>
    ...
    <AppLayout>
        <template
            #header
            class="hidden bg-white shadow-lg shadow-sky-600/20 sm:block"
        >
                ...
                >
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            ...
                            accueillir et vous accompagner dans la pratique de
                            votre discipline favorite !
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            Pour chaque clubs, vous pourrez y trouver les lieux
                            de pratique, les horaires et les tarifs. Un maximum
                            de détails pour vous aider dans votre choix !
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div class="max-w-sm mx-auto text-gray-700 md:px-8">
                    ...
                    <div class="flex items-center justify-center mb-4">
                        <Link
                            ...
                            class="flex items-center justify-center px-4 py-3 text-lg text-gray-700 transition duration-150 bg-white rounded shadow-lg hover:bg-darkblue hover:text-gray-600 hover:ring-2 hover:ring-green-400 hover:ring-offset-2 focus:ring-2 focus:ring-green-400 focus:ring-offset-2 sm:rounded-lg"
                        >
                        ...
                        <Link
                            v-else
                            :href="route('register')"
                            class="flex items-center justify-center px-4 py-3 text-lg text-gray-700 transition duration-150 bg-white rounded shadow-lg hover:bg-green-200 hover:text-gray-600 hover:ring-2 hover:ring-green-400 hover:ring-offset-2 focus:ring-2 focus:ring-green-400 focus:ring-offset-2 sm:rounded-lg"
                        >
                            S'inscrire
                            <span>
                                <ArrowNarrowRightIcon class="w-6 h-6 ml-2" />
