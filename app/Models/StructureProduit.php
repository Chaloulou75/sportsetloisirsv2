...
class StructureProduit extends Model
{
    ...
    public function scopeWithRelations(Builder $query): void
    {
        $query->with([
            ...
            'cat_tarifs.cat_tarif_type.tarif_attributs.valeurs.sous_attributs',
            'cat_tarifs.cat_tarif_type.tarif_attributs.valeurs.sous_attributs.valeurs',
            'cat_tarifs.cat_tarif_type.tarif_booking_fields',
            'cat_tarifs.cat_tarif_type.tarif_booking_fields.valeurs',
            'cat_tarifs.cat_tarif_type.tarif_booking_fields.valeurs.sous_fields',
            'cat_tarifs.cat_tarif_type.tarif_booking_fields.valeurs.sous_fields.valeurs',
