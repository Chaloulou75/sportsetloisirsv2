...
class CityDisciplineCategorieStructureController extends Controller
{
     ...
     */
    public function show(Request $request, City $city, ListDiscipline $discipline, $category, Structure $structure): Response
    {
        ...
        $currentRoute = [
                    'name' => 'villes.disciplines.categories.structures.show',
                    'params' => [
                        'city' => $city,
